...
class ExportCabrilloManager(private val activity: MainActivity) {
    ...
    fun gerarConteudoCabrillo(startTime: String): String {
        ...
        try {
            ...
            val contestId = contestCursor.getInt(contestCursor.getColumnIndexOrThrow("id"))
            val cabrilloName = contestCursor.getString(contestCursor.getColumnIndexOrThrow("CabrilloName"))
            val cabrilloMode = contestCursor.getString(contestCursor.getColumnIndexOrThrow("Mode"))
            val sendExchange = contestCursor.getString(contestCursor.getColumnIndexOrThrow("SendExchange"))
            val cabrilloCategory = contestCursor.getString(contestCursor.getColumnIndexOrThrow("Operator"))
            val cabrilloBand = contestCursor.getString(contestCursor.getColumnIndexOrThrow("Band"))
            val cabrilloPower = contestCursor.getString(contestCursor.getColumnIndexOrThrow("Power"))
            val cabrilloAssisted = contestCursor.getString(contestCursor.getColumnIndexOrThrow("Assisted"))
            val cabrilloTransmitter = contestCursor.getString(contestCursor.getColumnIndexOrThrow("Transmitter"))
            ...
            builder.appendLine("CATEGORY-OPERATOR: $cabrilloCategory")
            builder.appendLine("CATEGORY-ASSISTED: $cabrilloAssisted")
            builder.appendLine("CATEGORY-BAND: $cabrilloBand")
            builder.appendLine("CATEGORY-MODE: $cabrilloMode")
            builder.appendLine("CATEGORY-TRANSMITTER: $cabrilloTransmitter")
            builder.appendLine("CATEGORY-POWER: $cabrilloPower")
            builder.appendLine("CLUB: ${club.ifEmpty { "UNKNOWN" }}")
            builder.appendLine("CREATED-BY: QRU v0.7.2")
            ...
            builder.appendLine("SOAPBOX: https://github.com/oresmius/qru_kotlin")
            builder.appendLine()
